...
def get_data_from_file(file_path='/Users/haocheng/Downloads/BIA660D-master/Assignment_01/assignment_01.txt'):
...
def main():
    ...
    if 'does' in q_trip.subject.lower() and 'like' in sentence1:
    ...
    if 'when' in q_trip.object.lower() and (root.lemma_ == 'fly' or root.lemma_ == 'go' or root.lemma_ == 'travel'):
        qdoc=nlp(unicode(question))
